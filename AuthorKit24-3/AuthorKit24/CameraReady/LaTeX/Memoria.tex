...
\footnote{\textsuperscript{}Conjuntos de casillas sin ninguna parez entre ellos que forman zonas donde la navegación permite todas las acciones posibles.} 
así como la búsqueda de un abstracción más eficiente para el sistema de control feudal. Se preveé que con estas medidas se podrían obtener resultados similares o mejores para el método basado en q-learning para el problema propuesto al intentar simplificar el laberinto e intentar aprovechar al máximo toda la información disponible en cada momento.
