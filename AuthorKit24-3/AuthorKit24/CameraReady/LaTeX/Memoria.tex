...
añaden cierto valor en aquellos problemas que cuentan con un fin complejo que se puede presentar como una suma de tareas a tratar de forma paralela 
y ordenada. En otras palabras, de forma jerárquica. Este sistema emplea agentes a distintos niveles de abstracción para resolver el problema, que les permite tomar decisiones con un nivel de abstracción que no está influenciado por factores de menor nivel.

Por otro lado, se ha podido observar la influencia de la sobre-división de las tareas. Al dividir una tarea en demasiados niveles de abstracción, se realizaba
...
se ve bien representado en la selección de los destinos a navegar, en los que, debido a la excesiva abstracción del mapa de estados, se perdía la información
espacial de las paredes. 

Aunque la abstracción puede funcionar en otros entornos, en este problema se emplea un mapa con una naturaleza más cerrada, lo que no permite una abstracción efectiva para la tarea de navegación estudiada.

\section{Trabajo Futuro}
En vista de las limitaciones presentes del entorno, se plantea como trabajo para continuar 
el cambio del método de generación del laberinto por uno que permita definir "claros"
\footnote{\textsuperscript{}Conjuntos de casillas sin ninguna pared entre ellos que forman zonas donde la navegación permite todas las acciones posibles.} 
así como la búsqueda de una abstracción más eficiente para el sistema de control feudal. Se prevé que con estas medidas se podrían obtener resultados similares o mejores para el método basado en q-learning para el problema propuesto al intentar simplificar el laberinto e intentar aprovechar al máximo toda la información disponible en cada momento.
...
El código usado para la creación de esta memoria y los experimentos puede ser encontrado 
en el repositorio de github: \url{https://github.com/100451058/Aprendizaje_refuerzo/}. 
En la carpeta \texttt{src}, se puede encontrar el código para la generación del entorno
de simulación.
