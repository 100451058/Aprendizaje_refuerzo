...
aleatoriamente en casillas libres del mapa. Para poder ser usados en CNN y RNN, por cada celda original se obtienen 4 celdsa con las paredes.
Esto genera un laberinto con dos veces el tamaño original como se ve en Fig. \ref{fig:maze-example}.
...
se basa en una implementación que refleja fielmente los alineamientos de los sistemas de control feudales descritos. Basandose
en el ejemplo de la publicación, se han planteado una jerarquía de cuatro niveles en la que cada manager tiene la mitad de resolución 
...
\begin{figure}[H]
    ...
    \caption{Abstracciones y Niveles de Manager (cuadrado verde)\label{fig:feudal-abstract}}
\end{figure}
...
\subsubsection{Pruebas Q Learning}
